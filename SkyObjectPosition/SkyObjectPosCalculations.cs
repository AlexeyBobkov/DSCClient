...
namespace SkyObjectPosition
{
    public struct SkyObjectPosCalc
    {
        ...
        {
            new StarPosition("M1", "(PN) Crab Nebula NGC 1952",5.575,22.01666667),
            new StarPosition("M2", "(GC) NGC 7089",21.55833333,-0.833333333),
            new StarPosition("M3", "(GC) NGC 5272",13.70333333,28.38333333),
            new StarPosition("M4", "(GC) NGC 6121",16.395,-26.52575),
            new StarPosition("M5", "(GC) NGC 5904",15.30833333,2.083333333),
            new StarPosition("M6", "(OC) Butterfly Cluster NGC 6405",17.66833333,-32.21666667),
            new StarPosition("M7", "(OC) Ptolemy's Cluster NGC 6475",17.89833333,-34.81666667),
            new StarPosition("M8", "(DN) Lagoon Nebula NGC 6523",18.05333333,-24.38333333),
            new StarPosition("M9", "(GC) NGC 6333",17.31833333,-18.51666667),
            new StarPosition("M10", "(GC) NGC 6254",16.95166667,-4.116666667),
            new StarPosition("M11", "(OC) Wild Duck Cluster NGC 6705",18.85166667,-6.266666667),
            new StarPosition("M12", "(GC) NGC 6218",16.78666667,-1.95),
            new StarPosition("M13", "(GC) Hercules Cluster NGC 6205",16.695,36.45),
            new StarPosition("M14", "(GC) NGC 6402",17.62666667,-3.25),
            new StarPosition("M15", "(GC) NGC 7078",21.5,12.16666667),
            new StarPosition("M16", "(DN) Eagle Nebula NGC 6611",18.31333333,-13.78333333),
            new StarPosition("M17", "(DN) Omega, Swan, Horseshoe, Checkmark Nebula NGC 6618",18.34666667,-16.18333333),
            new StarPosition("M18", "(OC) NGC 6613",18.33166667,-17.13333333),
            new StarPosition("M19", "(GC) NGC 6273",17.04333333,-26.25),
            new StarPosition("M20", "(DN) Trifid Nebula NGC 6514",18.03166667,-23.03333333),
            new StarPosition("M21", "(OC) NGC 6531",18.07833333,-22.5),
            new StarPosition("M22", "(GC) Sagittarius Cluster NGC 6656",18.60666667,-23.91666667),
            new StarPosition("M23", "(OC) NGC 6494",17.94833333,-19.01666667),
            new StarPosition("M24", "(SC) Sagittarius Star Cloud, Milky Way Patch NGC 6603",18.30666667,-18.41666667),
            new StarPosition("M25", "(OC) IC 4725",18.52833333,-19.25),
            new StarPosition("M26", "(OC) NGC 6694",18.755,-9.4),
            new StarPosition("M27", "(PN) Dumbbell Nebula NGC 6853",19.99333333,22.71666667),
            new StarPosition("M28", "(GC) NGC 6626",18.41,-24.86666667),
            new StarPosition("M29", "(OC) NGC 6913",20.39833333,38.53333333),
            new StarPosition("M30", "(GC) NGC 7099",21.67166667,-23.18333333),
            new StarPosition("M31", "(GX) Andromeda Galaxy NGC 224",0.711666667,41.26666667),
            new StarPosition("M32", "(GX) Satellite of M31 NGC 221",0.711666667,40.86666667),
            new StarPosition("M33", "(GX) Triangulum/Pinwheel Galaxy NGC 598",1.563333333,30.65),
            new StarPosition("M34", "(OC) NGC 1039",2.7,42.78333333),
            new StarPosition("M35", "(OC) NGC 2168",6.148333333,24.33333333),
            new StarPosition("M36", "(OC) NGC 1960",5.588333333,34.15),
            new StarPosition("M37", "(OC) NGC 2099",5.873333333,32.55),
            new StarPosition("M38", "(OC) NGC 1912",5.478333333,35.83333333),
            new StarPosition("M39", "(OC) NGC 7092",21.53666667,48.43333333),
            new StarPosition("M40", "(DS) Winnecke 4",12.39,58.05),
            new StarPosition("M41", "(OC) NGC 2287",6.783333333,-20.73333333),
            new StarPosition("M42", "(DN) Orion Nebula NGC 1976",5.59,-5.383333333),
            new StarPosition("M43", "(DN) De Mairan's Nebula NGC 1982",5.593333333,-5.266666667),
            new StarPosition("M44", "(OC) Beehive Cluster (Praesepe) NGC 2632",8.671666667,19.81666667),
            new StarPosition("M45", "(OC) Pleiades, Subaru, Seven Sisters",3.785,24.11666667),
            new StarPosition("M46", "(OC) NGC 2437",7.696666667,-14.81666667),
            new StarPosition("M47", "(OC) NGC 2422",7.61,-14.48333333),
            new StarPosition("M48", "(OC) NGC 2548",8.228333333,-5.783333333),
            new StarPosition("M49", "(GX) NGC 4472",12.495,7.983333333),
            new StarPosition("M50", "(OC) NGC 2323",7.05,-8.333333333),
            new StarPosition("M51", "(GX) Whirlpool Galaxy NGC 5194",13.49833333,47.2),
            new StarPosition("M52", "(OC) NGC 7654",23.40333333,61.58333333),
            new StarPosition("M53", "(GC) NGC 5024",13.215,18.16666667),
            new StarPosition("M54", "(GC) NGC 6715",18.92,-30.46666667),
            new StarPosition("M55", "(GC) NGC 6809",19.66833333,-30.93333333),
            new StarPosition("M56", "(GC) NGC 6779",19.27666667,30.16666667),
            new StarPosition("M57", "(PN) Ring Nebula NGC 6720",18.89333333,33.03333333),
            new StarPosition("M58", "(GX) NGC 4579",12.625,11.81666667),
            new StarPosition("M59", "(GX) NGC 4621",12.7,11.65),
            new StarPosition("M60", "(GX) NGC 4649",12.72666667,11.55),
            new StarPosition("M61", "(GX) NGC 4303",12.36666667,4.466666667),
            new StarPosition("M62", "(GC) NGC 6266",17.02166667,-30.11666667),
            new StarPosition("M63", "(GX) Sunflower Galaxy NGC 5055",13.26333333,42.03333333),
            new StarPosition("M64", "(GX) Black Eye Galaxy NGC 4826",12.94666667,21.68333333),
            new StarPosition("M65", "(GX) Leo Triplet NGC 3623",11.315,13.1),
            new StarPosition("M66", "(GX) Leo Triplet NGC 3627",11.33666667,13),
            new StarPosition("M67", "(OC) NGC 2682",8.841666667,11.81666667),
            new StarPosition("M68", "(GC) NGC 4590",12.65833333,-26.75),
            new StarPosition("M69", "(GC) NGC 6637",18.52333333,-32.35),
            new StarPosition("M70", "(GC) NGC 6681",18.72166667,-32.3),
            new StarPosition("M71", "(GC) NGC 6838",19.895,18.78333333),
            new StarPosition("M72", "(GC) NGC 6981",20.89,-12.55),
            new StarPosition("M73", "(Asterism) Group of 4 stars NGC 6994",20.985,-12.63333333),
            new StarPosition("M74", "(GX) NGC 628",1.611666667,15.78333333),
            new StarPosition("M75", "(GC) NGC 6864",20.10166667,-21.91666667),
            new StarPosition("M76", "(PN) Little Dumbell, Cork, Butterfly Nebula NGC 650",1.7,51.56666667),
            new StarPosition("M77", "(GX) Cetus A NGC 1068",2.711666667,-0.016666667),
            new StarPosition("M78", "(DN) NGC 2068",5.78,0.05),
            new StarPosition("M79", "(GC) NGC 1904",5.405,-24.51666667),
            new StarPosition("M80", "(GC) NGC 6093",16.285,-22.98333333),
            new StarPosition("M81", "(GX) Bode's Galaxy NGC 3031",9.926666667,69.06666667),
            new StarPosition("M82", "(GX) Cigar, Bode's Galaxy NGC 3034",9.933333333,69.7),
            new StarPosition("M83", "(GX) Southern Pinwheel Galaxy NGC 5236",13.61666667,-29.86666667),
            new StarPosition("M84", "(GX) NGC 4374",12.41666667,12.88333333),
            new StarPosition("M85", "(GX) NGC 4382",12.42333333,18.18333333),
            new StarPosition("M86", "(GX) NGC 4406",12.43666667,12.93333333),
            new StarPosition("M87", "(GX) Virgo A NGC 4486",12.51333333,12.38333333),
            new StarPosition("M88", "(GX) NGC 4501",12.53333333,14.41666667),
            new StarPosition("M89", "(GX) NGC 4552",12.59333333,12.55),
            new StarPosition("M90", "(GX) NGC 4569",12.61333333,13.16666667),
            new StarPosition("M91", "(GX) NGC 4548",12.59166667,14.5),
            new StarPosition("M92", "(GC) NGC 6341",17.285,43.15),
            new StarPosition("M93", "(OC) NGC 2447",7.741666667,-23.86666667),
            new StarPosition("M94", "(GX) NGC 4736",12.84833333,41.13333333),
            new StarPosition("M95", "(GX) NGC 3351",10.73166667,11.7),
            new StarPosition("M96", "(GX) NGC 3368",10.77833333,11.81666667),
            new StarPosition("M97", "(PN) Owl Nebula NGC 3587",11.24833333,55.03333333),
            new StarPosition("M98", "(GX) NGC 4192",12.23,14.9),
            new StarPosition("M99", "(GX) NGC 4254",12.31333333,14.41666667),
            new StarPosition("M100", "(GX) NGC 4321",12.38166667,15.81666667),
            new StarPosition("M101", "(GX) Pinwheel Galaxy NGC 5457",14.05333333,54.35),
            new StarPosition("M102", "(GX) Spindle Galaxy NGC 5866",15.108194444,55.763333333),
            new StarPosition("M103", "(OC) NGC 581",1.553333333,60.7),
            new StarPosition("M104", "(GX) Sombrero Galaxy NGC 4594",12.66666667,-11.61666667),
            new StarPosition("M105", "(GX) NGC 3379",10.79666667,12.58333333),
            new StarPosition("M106", "(GX) NGC 4258",12.31666667,47.3),
            new StarPosition("M107", "(GC) NGC 6171",16.54166667,-13.05),
            new StarPosition("M108", "(GX) NGC 3556",11.19333333,55.68333333),
            new StarPosition("M109", "(GX) NGC 3992",11.96,53.36666667),
            new StarPosition("M110", "(GX) Satellite of M31 NGC 205",0.671666667,41.68333333)
        };
    }
}
